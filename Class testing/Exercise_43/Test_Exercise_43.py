import unittest
from Exercise_43 import SimpleTaxCalculator
...
class TestCapitalGainTax(unittest.TestCase):
    ...
    def test_positive_profit(self):
        self.assertEqual(self.calc.capital_gains_tax(profit=1000), 190)

    def test_zero_profit(self):
        self.assertEqual(self.calc.capital_gains_tax(profit=0), 0)

    def test_negative_profit(self):
        self.assertEqual(self.calc.capital_gains_tax(profit=-1000), 0)